...
namespace Sayne
{
    ...
    public static class QuestPlans
    {
        private static readonly List<QuestPlan> All = new List<QuestPlan>
        {
            ...
            QuestPlan.EnemyKill("고블린 사냥꾼", "고블린", count: 10, goldReward: 300, EnemyID.Goblin),
            QuestPlan.LevelReach("무럭무럭", level: 3, goldReward: 200),
            QuestPlan.EnemyKill("오우거 학살자", "오우거", count: 5, goldReward: 500,
                EnemyID.Ogre, EnemyID.ArmedOgre, EnemyID.OgreBoss),
